 ...
 */
private class KanbanCardPreviewParameterProvider : PreviewParameterProvider<KanbanCardData> {
    override val values: Sequence<KanbanCardData> = sequenceOf(
...
private fun KanbanBoardCardPreview(
    @PreviewParameter(KanbanCardPreviewParameterProvider::class) kanbanCardData: KanbanCardData,
) {
    KanbanBoardCard(
